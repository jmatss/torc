...
public class BencodeDecode extends Bencode {
    private ByteBuffer buffer;

    public BencodeDecode(ByteBuffer buffer) {
        this.buffer = buffer;
    }

    public BencodeDecode(byte[] fileContent) {
        this(ByteBuffer.allocate(fileContent.length).put(fileContent));
        this.buffer.rewind();
    }

    public BencodeDecode(File file) throws IOException {
    ...
    throws EOFException, BencodeException, UnsupportedEncodingException {
        ...
        Map<BencodeString, BencodeResult> map = new TreeMap<>();
